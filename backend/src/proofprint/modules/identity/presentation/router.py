...
from proofprint.modules.identity.presentation.dependencies import AuthenticationDep, CurrentActorDep
from proofprint.modules.identity.presentation.schemas import (
    CurrentUserResponse,
    LoginRequest,
    TokenResponse,
)
